...
import {getListBy} from "../Category/CategoryService";
...
export default observer(function CategoryDrugList() {
    ...
    let columns = [
        {
            title: "Tên nhóm thuốc", field: "name", width: "35%"
        },
        {
            title: "Mã nhóm thuốc", field: "code",
        },
        {

...
export default observer(function CategoryTypeList() {
      ...
      render: (rowData) => (
        <MaterialButton
          ...
          onSelect={(rowData, method) => {
            if (method === 0) {
              handleEditCategoryType(rowData.id);
            } else if (method === 1) {
  ...
  return (
    <GlobitsTable
      ...
      handleSelectList={handleSelectListCategoryType}
      columns={columns}
